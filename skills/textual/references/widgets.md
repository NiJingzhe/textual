...
from textual import on, work, tailwind_tcss
from textual.worker import Worker, get_current_worker
```

## Tailwind Utility Sheet Notes

When using `tailwind_tcss()`, `Input` and `Label` widgets get compact default styling:
...
This keeps single-line widgets visually compact. Override with explicit classes or `!important` if needed.
